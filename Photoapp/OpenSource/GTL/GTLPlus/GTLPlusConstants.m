...
//NSString * const kGTLAuthScopePlusEmail =@"https://www.googleapis.com/auth/userinfo.email";
//NSString * const kGTLAuthScopePlusUserinfo=@"https://www.googleapis.com/auth/userinfo.profile";
