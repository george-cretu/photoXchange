...
- (void)initializeProgressBar {
	...
	self.lighterProgressColor = [UIColor colorWithRed:185.0/255.0 green:24.0/255.0 blue:24.0/255.0 alpha:1.0];
	self.darkerProgressColor = [UIColor colorWithRed:112.0/255.0 green:5.0/255.0 blue:5.0/255.0 alpha:1.0];
	self.lighterStripeColor = [UIColor colorWithRed:145.0/255.0 green:46.0/255.0 blue:46.0/255.0 alpha:1.0];
	self.darkerStripeColor = [UIColor colorWithRed:92.0/255.0 green:20.0/255.0 blue:20.0/255.0 alpha:1.0];
